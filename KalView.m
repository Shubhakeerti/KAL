...
static const CGFloat kHeaderHeight = 64.f;
...
- (void)addSubviewsToHeaderView:(UIView *)headerView
{
  ...
  const CGFloat kHeaderVerticalAdjust = 8.f;
...
//  [headerView addSubview:backgroundView];
  ...
  [previousMonthButton setImage:[UIImage imageNamed:@"nav_prev.png"] forState:UIControlStateNormal];
  ...
  headerTitleLabel.font = [UIFont fontWithName:@"HelveticaNeue-Light" size:17];
  headerTitleLabel.textAlignment = UITextAlignmentCenter;
  headerTitleLabel.textColor = [UIColor colorWithRed:0.0f/255.0f green:136.0f/255.0f blue:187.0f/255.0f alpha:1.0f];
...
//  headerTitleLabel.shadowOffset = CGSizeMake(0.f, 1.f);
  ...
  [nextMonthButton setImage:[UIImage imageNamed:@"nav_next.png"] forState:UIControlStateNormal];
  ...
  for (CGFloat xOffset = 0.f; xOffset < headerView.width; xOffset += 46.f, i = (i+1)%7) {
    CGRect weekdayFrame = CGRectMake(xOffset, 30.f, 46.f, kHeaderHeight - 29.0f);
    UILabel *weekdayLabel = [[UILabel alloc] initWithFrame:weekdayFrame];
    weekdayLabel.backgroundColor = [UIColor clearColor];
    weekdayLabel.font = [UIFont fontWithName:@"HelveticaNeue-Medium" size:10];
    weekdayLabel.textAlignment = UITextAlignmentCenter;
      weekdayLabel.textColor = [UIColor blackColor];
//    weekdayLabel.textColor = [UIColor colorWithRed:0.0f/255.0f green:136.0f/255.0f blue:187.0f/255.0f alpha:1.0f];
